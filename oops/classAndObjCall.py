...
# sprint(Employee.return_full_name(emp1))
...
# this will print the namespace or object values of the emp1 Instance and
# if we see there is no raise amount in there
